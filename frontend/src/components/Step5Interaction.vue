          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">対話対象を選択</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || '未知の職業' }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">レポート生成エージェントのクイック対話版。4つの専門ツールを呼び出し可能で、MiroFishの完全な記憶を持っています</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge ディープアトリビューション</div>
                    <div class="tool-desc">現実世界のシードデータとシミュレーション環境の状態を一致させ、グローバル/ローカルメモリ機構と組み合わせて、時空を超えた詳細なアトリビューション分析を提供します</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch 全景トラッキング</div>
                    <div class="tool-desc">グラフ構造に基づく幅優先探索アルゴリズムにより、イベントの伝播経路を再構築し、情報フロー全体のトポロジー構造を捉えます</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch クイック検索</div>
                    <div class="tool-desc">GraphRAGに基づく即時クエリインターフェース。インデックス効率を最適化し、特定のノード属性と個別の事実を迅速に抽出するために使用されます</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent バーチャルインタビュー</div>
                    <div class="tool-desc">自律的なインタビュー機能。シミュレーション世界内の個体と並行して複数回の対話を行い、非構造化された見解データや心理状態を収集します</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || '未知の職業' }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">自己紹介</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Report Agentと対話し、レポート内容を深く理解する' : 'シミュレーション個体と対話し、彼らの見解を理解する' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || '未知の職業' }}</span>
                  </div>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="選択したすべての対象に質問したい内容を入力してください..."
                rows="3"
              ></textarea>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || '未知の職業' }}</span>
                  </div>
                </div>
...
const sendToReportAgent = async (message) => {
  addLog(`Report Agentに送信: ${message.substring(0, 50)}...`)
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('まずシミュレーション個体を選択してください')
  }
  ...
  if (res.success && res.data) {
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} が返答しました`)
    } else {
...
const submitSurvey = async () => {
  ...
  addLog(`${selectedAgents.value.size} 人の対象にアンケートを送信しています...`)
...
const loadReportData = async () => {
  ...
  try {
    ...
    addLog(`レポートのロードに失敗しました: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`${profiles.value.length} 個のシミュレーション個体を読み込みました`)
    }
  } catch (err) {
