<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">推論履歴</span>
      <div class="section-line"></div>
    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                <div class="modal-empty" v-else>関連ファイルはありません</div>
              </div>
            </div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">推論リプレイ</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3「シミュレーション開始」およびStep5「詳細なインタラクション」は実行中に起動する必要があります。履歴リプレイには対応していません。</span>
            </div>
          </div>
        </div>
      </Transition>
...
const getSimulationTitle = (requirement) => {
  if (!requirement) return '無名のシミュレーション'
