        ...
        <div class="left-panel">
          ...
          <div class="steps-container">
            <div class="steps-header">
               <span class="diamond-icon">◇</span> ワークフローシーケンス
            </div>
            <div class="workflow-list">
              <div class="workflow-item">
                <span class="logo-sub">マルチエージェント推論システム</span>
                <div class="step-info">
                  <div class="step-title">グラフ構築</div>
                  <div class="step-desc">現実シード抽出 & 個体・集団記憶注入 & GraphRAG構築</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">エンティティ関係抽出 & ペルソナ生成 & 環境設定Agentへのシミュレーションパラメータ注入</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">デュアルプラットフォーム並列シミュレーション & 予測要件の自動解析 & 時系列記憶の動的更新</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgentは豊富なツールセットを用いてシミュレーション環境と深くインタラクションします</div>
                </div>
              </div>
              <div class="workflow-item">
                <span class="step-num">05</span>
                <div class="step-info">
                  <div class="step-title">詳細インタラクション</div>
                  <div class="step-desc">シミュレーション世界内の任意の個体や、ReportAgentとの対話</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">01 / 現実のシード</span>
                <span class="console-meta">サポート形式: PDF, MD, TXT</span>
              </div>
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">ファイルをドラッグ＆ドロップしてアップロード</div>
                  <div class="upload-hint">またはクリックしてファイルシステムを参照</div>
                </div>
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">>_ 02 / シミュレーション・プロンプト</span>
              </div>
